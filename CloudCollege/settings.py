# -*- coding: utf-8 -*-
"""
Django settings for CloudCollege project.
...
ROOT_URLCONF = 'CloudCollege.urls'
...
WSGI_APPLICATION = 'CloudCollege.wsgi.application'
