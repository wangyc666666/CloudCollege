...
#    title = models.CharField('课程标题', max_length=30)
#    content = RichTextField('课程内容', blank=True, null=True)
#    course_price = models.IntegerField('课程价格(默认免费)', blank=True, default=0)
#    course_introduction = RichTextField('课程大纲', blank=True, null=True)
#    student_comments = RichTextField('学员评价', blank=True, null=True)
#    newpic = models.ImageField('封面图片', upload_to="images/", default="upload_imgss/logo.jpg")
#    courses_video = models.ManyToManyField('News', blank=True, null=True)
...
#    create_date = models.DateTimeField('发布时间', auto_now_add=True,blank=True, null=True)
...
class NewType(models.Model):
    ...
    display = models.CharField('标签云', max_length=50, blank=True, null=True)
...
class Category(models.Model):
    ...
    administrator = models.ForeignKey('Admin')
